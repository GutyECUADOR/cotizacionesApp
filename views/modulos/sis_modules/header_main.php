  ...
  <div class="container-fluid">
    ...
    <div class="navbar-header">
      ...
      <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
        ...
        <li class="dropdown">
                <a href="#" class="navbar-brand dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false"><?php echo APP_NAME; ?><span class="caret"></span></a>
                <ul class="dropdown-menu">
                    <li><a href="?action=inicio">Cotizacion Simple </a></li>
                    <li><a href="?action=multiempresa">Cotizacion Multiempresa </a></li>
